...
#	print(type(batch[1]))
	return out_batch
def train(train_path, test_path,rep_type,learning_rate, batch_size, num_epochs, 
	  inp_dim0, inp_dim1,use_model, model_path, hidden_dim = 500, all_gpu=False):
...
parser.add_argument('--train_path',type=str, default=main_path+'DeepSpeech/data/test_manifest.csv')
parser.add_argument('--test_path',type=str, default=main_path+'/DeepSpeech/data/validated_small.tsv')
...
rep_type = ['spec', 'conv', 'rnn_0', 'rnn_1', 'rnn_2', 'rnn_3', 'rnn_4']
...
parser.add_argument('--model_path', type= str, metavar='DIR', help='path to the Deepspeech Acoustic model', 
